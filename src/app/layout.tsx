...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Seattle Sparkle Cleaning - House Cleaning Seattle WA" }],
  },
  twitter: {
  ...
  verification: {
    google: "V98e9dzcxn8_yCQbNRtODpZ_B9PKiWnId3VydV963Eg",
  },
};
